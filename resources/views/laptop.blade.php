            ...
            <div class="container" style="background-color: #f5f5f5;margin-left:0px;  width: 1130px;line-height: 50px; border-top:2px solid #f5f5f5;">
                <div class="col-md-3">
                    ...
                    <select onchange="location.href=this.value">
                        ...
                        <option value="{{route('sap_xep',"new")}}">Mới nhất</option>
                        <option value="{{route('sap_xep',"low-price")}}">Giá: thấp -&gt; cao</option>
                        <option value="{{route('sap_xep',"height-price")}}">Giá: cao -&gt; thấp</option>
                                ...
                                <div class="product-item" style="background-color:#fff;width: 260px; height: 420px;">
                                    <div class="product-item-content">
                                        ...
                                        <div style="margin-top: 232px;text-align: center;">
                                            <h4 style="font-style: bold;" class="product-name"><a class="product-name-1" href="{{route('product-detail',$product->id)}}">{{$product->product_name}}</a></h4>
                                ...
                                <div class="overlay">
                                    <div>
                                        <div style="margin-left: 10px;margin-right: 10px;">
                                            ...
                                            <div style="margin-top:10px; font-size: 20px; color: red;font-style: bold;">
