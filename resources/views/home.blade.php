    ...
    <div class="view-home">
        <div class="container">
            ...
            <div class="discount-products">
                <div class="wrapper-title-discount-product"><h3 class="title-discount-product">Sản phẩm khuyến mãi</h3>
                </div>
                            ...
                            <div class="product-item">
                                <div class="product-item-content">
                                    ...
                                    <a href="{{route('product-detail',$product->id)}}"
                                       class="btn btn-primary btn-block"><i class="fas fa-search-plus"></i> Chi tiết</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
