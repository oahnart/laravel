...
<div class="menu" style="margin-top:-15px;background-color:#e0e0e0;">
    <div class="container">
        <ul class="list-inline">
                ...
                <li style="border-bottom:3px solid red;"><a href="{{route('thong-tin')}}"><h4 style="font-weight: bold;">KÊNH THÔNG TIN</h4></a></li>
            </ul>
    </div>
</div>
...
<div class="view-home">
    <div class="container">
        ...
        <div class="container" style="width:1140px;">
            <h1><strong style="color: #555;">KÊNH THÔNG TIN - CỘNG ĐỒNG</strong></h1>
            <div class="container" style="background-color: #f5f5f5;width:1140px;margin-top: 20px;">
                <div class="list-tin-1 float-left">
                    <h4 style="background-color: red; color: #fff;padding:5px 5px 5px 5px;"><strong>Thông tin Công nghệ - Thể thao - Giải trí</strong></h4>
                    ...
                    @endforeach
                    <h4 style="background-color: blue; color: #fff;padding:5px 5px 5px 5px;"><strong>Cộng đồng Công nghệ</strong></h4>
                    @foreach($list_tin_1 as $product)
                    <a href="{{route('product-detail',$product->id)}}" >
                        <div class="list-tin-1-1">
                            <div style="float: left;">
                ...
                <div class="list-tin-2 float-right">
                    <div style="line-height: 40px;border-bottom: 2px solid #f5f5f5;">
                        <h4 style="background-color: blue; color: #fff;padding:5px 5px 5px 5px;">Quảng cáo</h4>
                    </div>
